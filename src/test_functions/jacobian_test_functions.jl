...
function jacobian_test_functions(nlp::GridapPDENLPModel; udc = false, tol = 1e-15)
  ...
  @test_throws DimensionError jac(nlp, vcat(nlp.meta.x0, 1.0))
  @test_throws DimensionError jac_coord(nlp, vcat(nlp.meta.x0, 1.0))
  ...
  @test_throws DimensionError jprod(nlp, vcat(nlp.meta.x0, 1.0), nlp.meta.x0)
  @test_throws DimensionError jprod(nlp, nlp.meta.x0, vcat(nlp.meta.x0, 1.0))
  ...
  @test_throws DimensionError jtprod(nlp, vcat(nlp.meta.x0, 1.0), nlp.meta.y0)
  @test_throws DimensionError jtprod(nlp, nlp.meta.x0, vcat(nlp.meta.y0, 1.0))
