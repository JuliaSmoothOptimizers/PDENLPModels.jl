...
function assemble_jac_vals!(
    ...
    for (cellmat_rc, cellidsrows, cellidscols) in zip(matdata...)
        ...
        cell_cols = Gridap.FESpaces.get_cell_dofs(a.trial, cellidscols)
        cellmat_r =
            Gridap.FESpaces.attach_constraints_cols(a.trial, cellmat_rc, cellidscols)
...
function _jac_from_term_to_terms_u!(
    ...
    cell_u_to_cell_residual =
        Gridap.FESpaces._change_argument_to_cell_u(uh_to_cell_residual, U)
...
function _jac_from_term_to_terms_y!(
    ...
    cellvals_y = Gridap.FESpaces.autodiff_cell_jacobian_from_residual(
        yh_to_cell_residual,
        yh,
        cellids,
    )
